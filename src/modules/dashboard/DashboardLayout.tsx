...
function DashboardLayout(): React.ReactElement {
  const { accessToken, isLoggedIn } = useSelector((state: RootState) => state.user)
  const { isLoading } = useSelector((state: RootState) => state.refetch)
    ...
    <div className="dashboard-layout flex flex-col h-screen">
      {isLoggedIn && accessToken !== undefined ? (
        <>
          ...
          <div className="dashboard-main flex gap-x-5 items-start flex-1">
            <Sidebar />
            <div className="dashboard-children px-5 flex-1 mt-5 mb-10">
              <Outlet />
            </div>
          </div>
          {isLoading ? (
        ...
        <div className="dashboard-children p-5 flex-1 mt-5 flex gap-5 items-center justify-center ">
          <div className="flex flex-col gap-5 items-center justify-center bg-white w-full max-w-[500px] p-5">
            <div id="gears">
              <svg
